...
public class Cadastrar {
    ...
    public void CadastrarNomes(String nome, String sobrenome, String email, String partida, String saida, String numero, String url) {
        List<String> existentes = LinhaExistentes(url);
        String linha = nome + ";" + sobrenome + ";" + email + ";" + partida + ";" + saida + ";" + numero;
